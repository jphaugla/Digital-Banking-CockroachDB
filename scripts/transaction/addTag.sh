...
curl -X PUT -H "Content-Type: application/json"  "http://localhost:5001/api/transaction/addTag?transactionId=0000342e-cf94-4a8d-868f-c22b7597b465&tag=${newTag}&operation=add"
