...
public class PhoneController {
	...
	public ResponseEntity<Phone> getPhone(@RequestParam String phone) {
	...
	public ResponseEntity <List<Phone>> getCustomerPhone(@RequestParam UUID customerId) {
		log.debug("IN get customerByPhone, phone is " + customerId);
		return ResponseEntity.ok(phoneService.getAllCustomerPhones(customerId));
	}
