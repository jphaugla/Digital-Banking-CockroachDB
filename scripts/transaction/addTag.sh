...
curl -X PUT -H "Content-Type: application/json"  "http://localhost:8080/api/transaction/addTag?transactionId=ffde473d-4cc9-45f8-bf79-2b865901ad7f&tag=${newTag}&operation=add"
