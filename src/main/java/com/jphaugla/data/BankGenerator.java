...
public class BankGenerator {
    ...
    public static List<Email> createEmail (UUID customerId) {
    ...
    public static List<Phone> createPhone (UUID customerId) {
    ...
    public static Transaction createRandomTransaction(DateTime newDate, Integer idx, Account account,
        ...
        Timestamp timestamp_old_data = new Timestamp(calendar.getTimeInMillis());
        calendar.setTime(aNewDate);
        Timestamp timestamp_a_new_date =  new Timestamp(calendar.getTimeInMillis());
        calendar.add(Calendar.DATE, -1);
        Date date_minus_one = calendar.getTime();
        Timestamp timestamp_minus_one = new Timestamp(calendar.getTimeInMillis());
        calendar.add(Calendar.DATE, -1);
        Date date_minus_two = calendar.getTime();
        Timestamp timestamp_minus_two = new Timestamp(calendar.getTimeInMillis());
       ...
       //  transaction.setTranid(tran_id);
        ...
        if(transactionStat == "POSTED") {
            ...
            transaction.setPostingDate(timestamp_a_new_date);
            ...
            transaction.setSettlementDate(timestamp_a_new_date);
            transaction.setInitialDate(timestamp_minus_one);
            transaction.setPostingDate(timestamp_old_data);
        } else {
            transaction.setInitialDate(timestamp_a_new_date);
            transaction.setPostingDate(timestamp_old_data);
